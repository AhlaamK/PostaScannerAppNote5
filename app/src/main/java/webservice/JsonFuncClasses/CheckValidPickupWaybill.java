...
/**
 * Created by ahlaam.kazi on 11/22/2017.
 */

public class CheckValidPickupWaybill {
    private CheckValidPickupWaybill.WayBill_Info d;
    ...
    public void setd(CheckValidPickupWaybill.WayBill_Info d) {
        this.d = d;
    }

    public CheckValidPickupWaybill.WayBill_Info getd() {
        return this.d;
    }
}
